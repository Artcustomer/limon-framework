...
package artcustomer.framework.layers {
	...
	import artcustomer.framework.layers.data.Driver3DInfo;
	import artcustomer.framework.layers.tools.scene.AbstractScene3D;
	import artcustomer.framework.layers.tools.template.AbstractEngineTemplate;
	import artcustomer.framework.utils.consts.LayerErrorType;
	
	[Event(name = "layer3dSetup", type = "artcustomer.framework.events.FrameworkLayer3DEvent")]
	[Event(name = "layer3dDestroy", type = "artcustomer.framework.events.FrameworkLayer3DEvent")]
	[Event(name = "layer3dError", type = "artcustomer.framework.events.FrameworkLayer3DEvent")]
	[Event(name = "layer3dCreate", type = "artcustomer.framework.events.FrameworkLayer3DEvent")]
	...
	public class Layer3D extends Object implements ILayer {
		...
		private function listenEvents():void {
			this.context.instance.addEventListener(FrameworkEvent.FRAMEWORK_RESIZE, handleFramework, false, 0, true);
		}
		...
		private function unlistenEvents():void {
			this.context.instance.removeEventListener(FrameworkEvent.FRAMEWORK_RESIZE, handleFramework);
		}
		...
		private function setupViewPort():void {
			...
			this.context.instance.viewPortContainer.addChild(_viewPort);
		}
		...
		private function destroyViewPort():void {
			if (_viewPort) {
				this.context.instance.viewPortContainer.removeChild(_viewPort);
		...
		private function setupStage3D():Boolean {
			_stage3D = this.context.instance.stageReference.stage3Ds[_index];
				...
				case('context3DCreate'):
					...
					if (_context3D) {
						...
						if ((_driverInfo == Context3DRenderMode.SOFTWARE) || (_driverInfo.indexOf('oftware') > -1)) {
							...
							this.context.instance.dispatchEvent(new FrameworkLayer3DEvent(FrameworkLayer3DEvent.LAYER3D_ERROR, false, false, this, _stage3D, LayerErrorType.SOFTWARE_MODE_DETECTED));
						}
						...
						this.context.instance.dispatchEvent(new FrameworkLayer3DEvent(FrameworkLayer3DEvent.LAYER3D_CREATE, false, false, this, _stage3D));
					} else {
						this.context.instance.dispatchEvent(new FrameworkLayer3DEvent(FrameworkLayer3DEvent.LAYER3D_ERROR, false, false, this, _stage3D, LayerErrorType.CONTEXT3D_UNDEFINED));
					}
					break;
			}
		}
		...
		private function handleErrorStage3D(e:ErrorEvent):void {
			switch (e.type) {
				case('error'):
					this.context.instance.dispatchEvent(new FrameworkLayer3DEvent(FrameworkLayer3DEvent.LAYER3D_ERROR, false, false, this, _stage3D, e.text));
					break;
		...
		public function setup():void {
			if (setupStage3D()) {
				...
				this.context.instance.dispatchEvent(new FrameworkLayer3DEvent(FrameworkLayer3DEvent.LAYER3D_SETUP, false, false, this, _stage3D));
			} else {
				this.context.instance.dispatchEvent(new FrameworkLayer3DEvent(FrameworkLayer3DEvent.LAYER3D_ERROR, false, false, this, null, LayerErrorType.STAGE3D_UNDEFINED));
			}
		}
		...
		public function destroy():void {
			...
			this.context.instance.dispatchEvent(new FrameworkLayer3DEvent(FrameworkLayer3DEvent.LAYER3D_DESTROY, false, false, this, this.stage3D));
