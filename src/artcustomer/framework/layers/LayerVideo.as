...
package artcustomer.framework.layers {
	import flash.events.*;
	...
	import artcustomer.framework.layers.tools.video.*;
	import artcustomer.framework.layers.tools.video.consts.*;
	import artcustomer.framework.utils.consts.LayerErrorType;
	
	
	[Event(name = "layerVideoAvailable", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoReady", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoSetup", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoDestroy", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoError", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoRender", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoPlayStream", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoPauseStream", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoResumeStream", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoStopStream", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoOnStream", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoMetaDataReceived", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoStreamNotFound", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoBufferEmpty", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoBufferFlush", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoBufferFull", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	[Event(name = "layerVideoChangeVolume", type = "artcustomer.framework.events.FrameworkLayerVideoEvent")]
	 ...
	 */
	public class LayerVideo extends Object implements ILayer {
		...
		private function listenEvents():void {
			this.context.instance.stageReference.addEventListener(StageVideoAvailabilityEvent.STAGE_VIDEO_AVAILABILITY, handleStageVideoAvailability, false, 0, true);
			this.context.addEventListener(FrameworkEvent.FRAMEWORK_RESIZE, handleFramework, false, 0, true);
		}
		...
		private function unlistenEvents():void {
			this.context.instance.stageReference.removeEventListener(StageVideoAvailabilityEvent.STAGE_VIDEO_AVAILABILITY, handleStageVideoAvailability);
			this.context.removeEventListener(FrameworkEvent.FRAMEWORK_RESIZE, handleFramework);
		}
		...
		private function handleStageVideoAvailability(e:StageVideoAvailabilityEvent):void {
			if (e.availability == StageVideoAvailability.UNAVAILABLE) {
				...
				this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_ERROR, false, false, this, null, _currentStream, LayerErrorType.STAGEVIDEO_UNAVAILABLE));
			} else {
				_isStageVideoAvailable = true;
				
				this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_AVAILABLE, false, false, this, null, _currentStream, null, _volume));
				...
				if (setupStageVideo()) {
					...
					this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_READY, false, false, this, this.stageVideo, _currentStream, null, _volume));
				} else {
					this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_ERROR, false, false, this, null, _currentStream, LayerErrorType.STAGEVIDEO_UNDEFINED));
				}
			}
		}
		...
		private function setupStageVideo():Boolean {
			_stageVideo = this.context.instance.stageReference.stageVideos[_index];
		...
		private function updateViewPortPosition(width:int = 0, height:int = 0):void {
			...
			var stageWidth:int = this.context.contextWidth;
			var stageHeight:int = this.context.contextHeight;
		...
		private function handleStageVideo(e:StageVideoEvent):void {
			switch (e.type) {
				case('renderState'):
					...
					this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_RENDER, false, false, this, this.stageVideo, _currentStream, null, _volume));
					break;
			}
		}
		...
		private function handleErrorStageVideo(e:ErrorEvent):void {
			switch (e.type) {
				case('error'):
					this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_ERROR, false, false, this, this.stageVideo, _currentStream, e.text, _volume));
					break;
			}
		}
		...
		private function handleNetStatus(e:NetStatusEvent):void {
			switch (e.info.code) {
				case ('NetStream.Play.StreamNotFound'):
					...
					this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_STREAM_NOT_FOUND, false, false, this, this.stageVideo, _currentStream, null, _volume));
					break;
					
				case ('NetStream.Play.Start'):
					this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_PLAYSTREAM, false, false, this, this.stageVideo, _currentStream, null, _volume));
					break;
					
				case ('NetStream.Play.Stop'):
					_allowRendering = false;
					
					this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_STOPSTREAM, false, false, this, this.stageVideo, _currentStream, null, _volume));
					break;
					
				case ('NetStream.Pause.Notify'):
					this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_PAUSESTREAM, false, false, this, this.stageVideo, _currentStream, null, _volume));
					break;
					
				case ('NetStream.Unpause.Notify'):
					this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_RESUMESTREAM, false, false, this, this.stageVideo, _currentStream, null, _volume));
					break;
				...
				case ('NetStream.Buffer.Empty'):
					this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_BUFFER_EMPTY, false, false, this, this.stageVideo, _currentStream, null, _volume));
					break;
					
				case ('NetStream.Buffer.Flush'):
					this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_BUFFER_FLUSH, false, false, this, this.stageVideo, _currentStream, null, _volume));
					break;
					
				case ('NetStream.Buffer.Full'):
					this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_BUFFER_FULL, false, false, this, this.stageVideo, _currentStream, null, _volume));
					break;
			}
		}
		...
		private function handleAsync(e:AsyncErrorEvent):void {
			switch (e.type) {
				case('asyncError'):
					this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_ERROR, false, false, this, null, _currentStream, LayerErrorType.STAGEVIDEO_ASYNCHRONOUS_ERROR, _volume));
					break;
			}
		}
		...
		public function setup():void {
			...
			this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_SETUP, false, false, this, this.stageVideo, _currentStream, null, _volume));
		}
		...
		public function destroy():void {
			...
			this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_DESTROY, false, false, this, this.stageVideo, _currentStream, null, _volume));
		...
		public final function onRender():void {
			if (_allowRendering) {
				...
				this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_ONSTREAM, false, false, this, this.stageVideo, _currentStream, null, _volume));
			}
		}
		...
		public final function setVolume(value:Number):void {
			...
			this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_CHANGE_VOLUME, false, false, this, this.stageVideo, _currentStream, null, _volume));
		}
		...
		public final function onMetaData(info:Object):void {
			...
			this.context.dispatchEvent(new FrameworkLayerVideoEvent(FrameworkLayerVideoEvent.LAYERVIDEO_METADATA_RECEIVED, false, false, this, this.stageVideo, _currentStream, null, _volume));
		}
