...
package artcustomer.framework.errors {
	...
	public class IllegalError extends IllegalOperationError {
		...
		public static const E_COMMANDCONTEXT_CONSTRUCTOR:String = "CommandContext is an abstract class ! Don't instantiate it directly !";
		...
		public static const E_VIEWMEDIATOR_CONSTRUCTOR:String = "Component is an abstract class ! Don't instantiate it directly !";
		public static const E_EVENTBORADCASTER_CONSTRUCTOR:String = "Component is an abstract class ! Don't instantiate it directly !";
		...
		public static const E_ABSTRACTVIEW_CONSTRUCTOR:String = "AbstractView is an abstract class ! Don't instantiate it directly !";
