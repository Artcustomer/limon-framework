...
package artcustomer.framework.render {
	...
	import artcustomer.framework.events.FrameworkRenderEvent;
	import artcustomer.framework.utils.consts.RenderEngineState;
	
	[Event(name = "onRender", type = "artcustomer.framework.events.FrameworkRenderEvent")]
	[Event(name = "startRender", type = "artcustomer.framework.events.FrameworkRenderEvent")]
	[Event(name = "stopRender", type = "artcustomer.framework.events.FrameworkRenderEvent")]
	[Event(name = "heartBeat", type = "artcustomer.framework.events.FrameworkRenderEvent")]
	 ...
	 */
	public class RenderEngine extends Object implements IDestroyable {
		...
		private function listenEnterFrame():void {
			_context.contextView.addEventListener(Event.ENTER_FRAME, handleEnterFrame, false, 0, true);
		}
		...
		private function unlistenEnterFrame():void {
			if (_context.contextView.hasEventListener(Event.ENTER_FRAME)) _context.contextView.removeEventListener(Event.ENTER_FRAME, handleEnterFrame);
		}
		...
		private function handleEnterFrame(e:Event):void {
			...
			_context.instance.render();
			_context.instance.dispatchEvent(new FrameworkRenderEvent(FrameworkRenderEvent.ON_RENDER, false, false, this, _fps, _memory, _freeMemory, _privateMemory, _totalMemory));
		}
		...
		private function tick():void {
			...
			if (_currentFrameTime >= _nextHeartbeatTime) {
				...
				_context.instance.dispatchEvent(new FrameworkRenderEvent(FrameworkRenderEvent.HEARTBEAT, false, false, this, _fps, _memory, _freeMemory, _privateMemory, _totalMemory));
			}
		...
		public function start():void {
			if (!_onRendering) {				
				...
				_context.instance.dispatchEvent(new FrameworkRenderEvent(FrameworkRenderEvent.START_RENDER, false, false, this, _fps, _memory, _freeMemory, _privateMemory, _totalMemory));
		...
		public function stop():void {
			if (_onRendering) {
				...
				_context.instance.dispatchEvent(new FrameworkRenderEvent(FrameworkRenderEvent.STOP_RENDER, false, false, this, _fps, _memory, _freeMemory, _privateMemory, _totalMemory));
				_state = RenderEngineState.RENDERENGINE_OFF;
				_onRendering = false;
			}
		}
