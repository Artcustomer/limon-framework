...
package artcustomer.framework.context.menu {
	...
	import artcustomer.framework.context.Context;
	...
	public class ContextFrameworkMenu extends Object implements IDestroyable {
		...
		private function setupContextMenu():void {
			_titleCaption = Context.currentContext.instance.name;
		...
		public function setup():void {
			_container = Context.currentContext.contextView;
